...
*Esta documentación refleja la implementación real usando la terminología correcta "ValuableAction" en lugar de las referencias obsoletas "ActionType", asegurando alineación con la visión del proyecto y la base de código.*
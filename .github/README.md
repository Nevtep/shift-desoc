...
## What Matters Most
- Timelock-only authority; ParamController as source of truth; no verifier staking/bonding; TreasuryAdapter guardrails (1 spend/week, ≤10% per token, stablecoin allowlist, pause/emergency withdraw); commerce disputes stay separate from work Engagements.

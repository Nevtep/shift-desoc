...
process.env.NEXT_PUBLIC_GOVERNOR ||= "0x0000000000000000000000000000000000000104";
process.env.NEXT_PUBLIC_TIMELOCK ||= "0x0000000000000000000000000000000000000105";
process.env.NEXT_PUBLIC_REQUEST_HUB ||= "0x0000000000000000000000000000000000000106";
process.env.NEXT_PUBLIC_DRAFTS_MANAGER ||= "0x0000000000000000000000000000000000000107";
process.env.NEXT_PUBLIC_ENGAGEMENTS ||= "0x0000000000000000000000000000000000000108";
process.env.NEXT_PUBLIC_POSITION_MANAGER ||= "0x0000000000000000000000000000000000000109";
process.env.NEXT_PUBLIC_VALUABLE_ACTION_REGISTRY ||= "0x0000000000000000000000000000000000000110";
process.env.NEXT_PUBLIC_VERIFIER_POWER_TOKEN ||= "0x0000000000000000000000000000000000000111";
process.env.NEXT_PUBLIC_VERIFIER_ELECTION ||= "0x0000000000000000000000000000000000000112";
process.env.NEXT_PUBLIC_VERIFIER_MANAGER ||= "0x0000000000000000000000000000000000000113";
process.env.NEXT_PUBLIC_VALUABLE_ACTION_SBT ||= "0x0000000000000000000000000000000000000114";
process.env.NEXT_PUBLIC_TREASURY_ADAPTER ||= "0x0000000000000000000000000000000000000115";
process.env.NEXT_PUBLIC_COMMUNITY_TOKEN ||= "0x0000000000000000000000000000000000000116";

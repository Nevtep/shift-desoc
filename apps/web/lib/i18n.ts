...
const dictionaries = {
  es: {
    ...
    governance: {
      ...
      hubTitle: "Gobernanza",
      hubSubtitle: "Consulta propuestas y votaciones. Los datos provienen del indexer; el detalle on-chain esta en el explorador.",
      hubCardProposalsTitle: "Propuestas",
      hubCardProposalsBody: "Lista, vota y sigue el ciclo de vida de cada propuesta.",
      hubCardActivityTitle: "Actividad (proximamente)",
      hubCardActivityBody: "Actualizaciones entre comunidades vinculadas al indice de gobernanza.",
      listTitle: "Propuestas de gobernanza",
      listSubtitle: "Propuestas con votacion ponderada. Usa el filtro para centrarte en una comunidad.",
      ...
      hubSectionProposalsBody: "Estado del ciclo, votacion ponderada y preparacion para ejecucion.",
      ...
      proposalDetailSubtitle:
        "Resumen orientado a miembros. Los datos de cadena, calldata y diagnosticos del indice estan en las secciones tecnicas.",
      proposalMismatch: "Esta propuesta pertenece a la comunidad #{actual}, no a la #{expected}.",
      openCorrectRoute: "Abrir la ruta correcta",
      atAGlance: "En brief",
      metadataTechnical: "Metadatos y direcciones (detalle)",
      stateLabel: "Estado",
      ...
      readinessHumanPending: "Seguimiento en curso. Abre el diagnostico tecnico si necesitas ETA o fuente de datos.",
  ...
  en: {
    ...
    governance: {
      ...
      hubTitle: "Governance",
      hubSubtitle:
        "Browse proposals and votes. Data is served by the indexer; treat the block explorer as the source of truth for raw chain state.",
      hubCardProposalsTitle: "Proposals",
      hubCardProposalsBody: "List items, cast votes, and follow lifecycle status.",
      hubCardActivityTitle: "Activity (coming soon)",
      hubCardActivityBody: "Cross-community feeds backed by the governance indexer.",
      listTitle: "Governance proposals",
      listSubtitle: "Weighted voting proposals. Use the filter when you want a single-community view.",
      ...
      hubSectionProposalsBody: "Lifecycle status, weighted voting, and execution readiness.",
      ...
      proposalDetailSubtitle:
        "Member-friendly summary. Chain data, calldata, and indexer diagnostics live in the technical sections below.",
      ...
      metadataTechnical: "Metadata and addresses (detail)",
      stateLabel: "State",
      ...
      readinessHumanPending: "In progress. Open technical diagnostics if you need ETA or data source details.",

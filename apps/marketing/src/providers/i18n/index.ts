...
export const translations = {
    en: {
        ...
        problem3: "Value flows to capital owners, not value creators",
        problem4: "Communities can't coordinate effectively at scale",
        solutionTitle: "Shift's Solution:",
        solution1: "Permanent proof of your contributions that follows you everywhere",
        solution2: "Multi-choice voting that captures what communities really want",
        solution3: "Fair distribution where value flows to those who create it",
        solution4: "Democratic coordination tools that scale from small groups to global networks",
        ...
        feature1Title: "Community-Defined Value System",
        feature1Description: "Communities democratically decide what work is valuable and how much it's worth. Whether it's coding, teaching, organizing events, or caring for others, each community defines value based on their needs and priorities.",
        feature2Title: "Multi-Choice Governance",
        feature2Description: "Instead of divisive binary votes, communities can express preferences across multiple options, leading to decisions that better reflect what people actually want.",
        feature3Title: "Community Marketplace",
        feature3Description: "Communities can trade services and resources with each other, with reputation ensuring quality while keeping value within the cooperative network instead of extracting it to distant shareholders.",
        feature4Title: "Treasury Management",
        feature4Description: "Transparent, community-controlled treasuries where members vote on spending priorities, investments, and financial decisions. Every transaction is visible and accountable.",
        feature5Title: "Portable Reputation",
        feature5Description: "Your reputation and achievements travel with you between communities. High contributors are welcomed into new communities based on their verified track record, creating a global network of cooperation.",
        feature6Title: "Peer-Verified Work",
        feature6Description: "Community members review each other's work submissions, ensuring quality while creating accountability. Multiple reviewers must agree before contributions are officially recognized.",
    ...
    es: {
        ...
        problem3: "El valor se va hacia los dueños del capital, no hacia quienes realmente crean valor",
        problem4: "Las comunidades no pueden coordinarse de forma efectiva a gran escala",
        solutionTitle: "La Solución de Shift:",
        solution1: "Prueba permanente de tus contribuciones que te acompaña a donde vayas",
        solution2: "Votación con múltiples opciones que captura lo que las comunidades realmente quieren",
        solution3: "Distribución justa donde el valor va hacia quienes lo crean",
        solution4: "Herramientas de coordinación democrática que crecen desde pequeños grupos hasta redes globales",
        ...
        feature1Title: "Sistema de Valor Definido por la Comunidad",
        feature1Description: "Las comunidades deciden democráticamente qué trabajo vale y cuánto vale. Ya sea programar, enseñar, organizar eventos o cuidar a otros, cada comunidad define el valor según sus necesidades y prioridades.",
        feature2Title: "Gobernanza Multi-Opción",
        feature2Description: "En lugar de votos binarios que dividen, las comunidades pueden expresar preferencias entre múltiples opciones, llegando a decisiones que reflejan mejor lo que la gente realmente quiere.",
        feature3Title: "Mercado Comunitario",
        feature3Description: "Las comunidades pueden intercambiar servicios y recursos entre sí, con la reputación asegurando calidad mientras mantienen el valor dentro de la red cooperativa en lugar de sacarlo hacia accionistas lejanos.",
        feature4Title: "Gestión del Tesoro",
        feature4Description: "Tesorerías transparentes y controladas por la comunidad donde los miembros votan sobre prioridades de gasto, inversiones y decisiones financieras. Cada transacción es visible y se puede rastrear.",
        feature5Title: "Reputación Portátil",
        feature5Description: "Tu reputación y logros te acompañan entre comunidades. Los grandes contribuyentes son bienvenidos en nuevas comunidades basándose en su historial verificado, creando una red global de cooperación.",
        feature6Title: "Trabajo Verificado por Pares",
        feature6Description: "Los miembros de la comunidad revisan el trabajo de otros, asegurando calidad mientras crean responsabilidad. Varios revisores deben estar de acuerdo antes de que las contribuciones sean reconocidas oficialmente.",

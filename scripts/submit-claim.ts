...
const DESCRIPTION = "Completed comprehensive smart contract security review including gas optimization analysis and multi-signature integration testing";
...
async function main() {
    ...
    try {
        ...
        console.log("   5. If rejected: claim can be appealed or resubmitted with improvements");
        console.log("");
        ...
        console.log("   • Check claim status: npx hardhat run scripts/check-claim-status.ts --network base_sepolia");
        ...
        console.log("   • Check if you have active claims that exceed maxConcurrent limit");
        ...
        console.log("   • Action not found: Governance proposal may not have executed yet");
        console.log("   • Cooldown active: Wait for cooldown period to expire");
        console.log("   • Max concurrent: Complete existing claims before submitting new ones");
